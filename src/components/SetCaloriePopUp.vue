<template>
    <div v-if = "showPopUp3" class = "setCalorieGoal">

        <div class = "topCalorieRow">
            <div id = "right-elem-c">
                <button @click = "closePopUp3" class = "close-icon-c">x</button>
            </div>
        </div>
        ...
        <button id = "addCalorieGoalButton" @click="addCalorieGoal">SET</button>
